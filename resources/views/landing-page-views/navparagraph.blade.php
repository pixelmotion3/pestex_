                          ...
                          <div class="card-body">
                            <nav>
                              <div class="nav nav-tabs overflow-scroll" id="nav-tab" role="tablist">
                                <button class="nav-link active" id="nav-paragraph-tab" data-bs-toggle="tab" data-bs-target="#nav-paragraph" type="button" role="tab" aria-controls="nav-paragraph" aria-selected="false"><small>Meta tags</small></button>
                            ...
                            <div class="tab-content mt-5" id="nav-tabContent">
                                ...
                                <div class="tab-pane fade show active" id="nav-paragraph" role="tabpanel" aria-labelledby="nav-paragraph-tab">
                                    <form class="row g-3 needs-validation" novalidate action="{{ route('landing-page.update', 1) }}" method="post">
									  ...
									  <div class="col-12">
										<button type="submit" class="btn btn-primary w-100" name="form0">Submit</button>
									  </div>
                                    </form>
                                </div>
                                 <!-- Quote form -->
                                <div class="tab-pane fade" id="quote-form" role="tabpanel" aria-labelledby="quote-form-tab">
                                    <form class="row g-3" action="{{ route('landing-page.update', 1) }}" method="post">
                                      ...
                                      <div class="col-12 mt-5">
                                          <label for="validationCustom01" class="form-label" style="float:left;">Meta Title (PT)</label>
                                          <input type="text" class="form-control" id="validationCustom01" value="{{ $main_screen[0]['meta-title'] }}" name="quote-form-tab-title-1" required>
                                        </div>
                                        <div class="col-12 mt-5">
                                          <label for="validationCustom01" class="form-label" style="float:left;">Meta Description (PT)</label>
                                          <input type="text" class="form-control" id="validationCustom01" value="{{ $main_screen[0]['meta-desctiption'] }}" name="quote-form-tab-title-2"  required>
                                        </div>
                                        <div class="col-12 mt-5">
                                          <label for="validationCustom01" class="form-label" style="float:left;">Meta Keywords (PT)</label>
                                          <input type="text" class="form-control" id="validationCustom01" value="{{ $main_screen[0]['meta-keywords'] }}" name="quote-form-tab-2-h2" required>
                                        </div>
