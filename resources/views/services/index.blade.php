...
<body class="custom-cursor" style="overflow-x: hidden;">
    ...
    <section class="cta-one">
        ...
        <div class="container">
            <div class="row d-flex align-items-center">
                <div class="col-lg-7 wow fadeInLeft" data-wow-delay="500ms">
                    <div class="cta-one__image">
                        <img src="../{{ $main_screen[0]['bg-img-2'] }}" alt="tolak" style="border-radius:30px;">
                    </div>
                </div>
                <div class="col-lg-5 wow fadeInUp" data-wow-delay="500ms">
    ...
    <section class="contact-one">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <div class="contact-one__info wow fadeInLeft" data-wow-delay="600ms">
        ...
        <div class="container contact-one__container wow fadeInUp" data-wow-delay="500ms">
