...
<head>
	...
	<meta name="description" content="{{ $service_detail['meta-desctiption']?? "SOS Pragas, Termos de serviços" }}">
    <!-- Fonts -->
			...
			<section class="termos-one space_between" id="#">
				<div class="container">
					<div class="text-center">
						...
						<h1 class="sec-title__title mt-5"><b>{{ $terms_service[0]['terms-title'] }}</b></h1>
						<!-- /.sec-title__title -->
					</div><!-- /.sec-title -->
