													...
													<div class="col-6">
														<a href="#"
															...
															if(result){
																...
																document.getElementById('delete-form-{{$contact_form['id']}}').submit();
															}
															">
															Marcar visto
														</a>
													</div>
													<form id="delete-form-{{$contact_form['id']}}"
														action="{{ route('formshandle.destroy', ['contact_form_id' => $contact_form['id'], 'type_form' => "contact_forms"]) }}"
