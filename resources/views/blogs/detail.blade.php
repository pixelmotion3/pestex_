            ...
            <div class="row gutter-y-30">
                <div class="col-lg-8 col-md-12 col-sm-12 content-side">
                    <div class="service-details-content container-fluid">
                        <div class="content-one">
							<div style="display: flex;align-items: center;gap: 10px;">
								@if($category_service != null)
									<span class="badge badge-light text-dark">{{$category_service}}</span>
								@endif

								<span>{{date("d M Y", strtotime($main['created_at']))}}</span>
							</div>
							<h3>{{$main['title']}}</h3>
                            <figure class="image-box"><img src="/{{$main["image"]}}" alt="Imagem demonstrativa do serviço">
                            </figure>
                            <div class="">
                                {!! $main['content'] !!}
                            </div>
                        ...
                        <h3 class="h3" style="color:black;"><b>Tags</b></h3>
						<div class="row">
							<div class="d-flex gap-2">
								@foreach ($tags_individual as $tag_individual)
									<span class="badge2 badge-light-two text-dark">{{$tag_individual['title']}}</span>
								@endforeach
							</div>
						</div>
            ...
            <div class="mail-section__wrapper">
                <div class="row">
                    ...
                    @php
                        ...
                        $baseUrl =
                            $domain === 'sospragas.pt' ? 'https://sospragas.pt' : 'https://desinfestacoes.sospragas.pt';
                    @endphp
