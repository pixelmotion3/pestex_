...
<head>
	...
	<!-- Meta Description -->
    <meta name="description" content="SOS Pragas, página de serviços">
...
<body class="custom-cursor" style="overflow-x: hidden;">
			...
			<div class="main-header__inner">
				...
				<nav class="main-header__nav main-menu">
					<ul class="main-menu__list">
						...
						<li class="scrollToLink current"><a href="/blogs" class="font-semibold">Blog</a></li>
    ...
    <section class="page-header" style="background-image: url(/{{ count($main_screen) > 0 ? $main_screen[0]['sec-1-image1'] : "" }});background-size: cover;background-repeat: no-repeat;background-position: center;">
        <div class="page-header__shape-two"></div>
        <div class="container">
            <div class="row">
                <div class="col-md-7">
                    <div class="page-header__content">
                        <h1 class="page-header__title">{{ count($main_screen) > 0 ? $main_screen[0]['sec-1-h1'] : "" }}</h1>
                    </div>
                </div>
                {{-- <div class="col-md-5">
                    <div class="page-header__layer wow fadeInUp" data-wow-delay="500ms">
	...
	<div class="sec-title text-center" style="margin-top:5%;">
