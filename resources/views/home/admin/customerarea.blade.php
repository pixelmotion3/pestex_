                          ...
                          <div class="card-body">
                            <nav>
                              <div class="nav nav-tabs overflow-scroll" id="nav-tab" role="tablist">
                                ...
                                <button class="nav-link active" id="watch-video+background-image-tab" data-bs-toggle="tab" data-bs-target="#watch-video+background-image" type="button" role="tab" aria-controls="watch-video+background-image" aria-selected="false"><small>Área Cliente</small></button>
                            ...
                            <div class="tab-content mt-5" id="nav-tabContent">
                                ...
                                <!-- WATCH VIDEO -->
                                <div class="tab-pane fade show active" id="watch-video+background-image" role="tabpanel" aria-labelledby="watch-video+background-image-tab">
