                        ...
                        <div class="card text-center">
                          ...
                          <div class="card-body">
                            ...
                            <div class="tab-content mt-5" id="nav-tabContent">
                                ...
                                <div class="tab-pane fade show active" id="three-images+six-icons+three-paragraphs" role="tabpanel" aria-labelledby="three-images+six-icons+three-paragraphs-tab">
                                  <form class="row g-3 needs-validation" novalidate action="{{ route('home-page.update', 2) }}" method="post" enctype="multipart/form-data">
                                      @csrf
                                      @method('PUT')
                                      <div class="col-12 mt-5">
