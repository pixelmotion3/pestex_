                          ...
                          <div class="card-body">
                            <nav>
                              <div class="nav nav-tabs overflow-scroll" id="nav-tab" role="tablist">
								...
								<button class="nav-link active" id="terms-service-tab" data-bs-toggle="tab" data-bs-target="#terms-service" type="button" role="tab" aria-controls="terms-service" aria-selected="false"><small>Termos de Serviço</small></button>
                            ...
                            <div class="tab-content mt-5" id="nav-tabContent">
								...
								<!-- TERM OF SERVICE -->
                                <div class="tab-pane fade show active" id="terms-service" role="tabpanel" aria-labelledby="terms-service-tab">
                                    ...
                                    <form class="row g-3 needs-validation" novalidate action="{{ route('home-page.update', 2) }}" method="post" enctype="multipart/form-data">
									  ...
									  <input type="hidden" value="{{ $terms_service[0]['terms-p-text-1'] }}" id="contentterms-p-text-1">
									  	<div class="col-12 mt-5">
											...
											<input type="text" class="form-control" id="validationCustom01" value="{{ $terms_service[0]['meta-title'] }}" name="meta-title" required>
										</div>
										<div class="col-12 mt-5">
											<label for="validationCustom01" class="form-label" style="float:left;">Meta Description (PT)</label>
											<input type="text" class="form-control" id="validationCustom01" value="{{ $terms_service[0]['meta-desctiption'] }}" name="meta-desctiption"  required>
										</div>
										<div class="col-12 mt-5">
											<label for="validationCustom01" class="form-label" style="float:left;">Meta Keywords (PT)</label>
											<input type="text" class="form-control" id="validationCustom01" value="{{ $terms_service[0]['meta-keywords'] }}" name="meta-keywords" required>
										</div>
                                      <div class="col-12">
