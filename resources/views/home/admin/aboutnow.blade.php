                          ...
                          <div class="card-body">
                            <nav>
                              <div class="nav nav-tabs overflow-scroll" id="nav-tab" role="tablist">
                                ...
                                <button class="nav-link active" id="background-images+text-tab" data-bs-toggle="tab" data-bs-target="#background-images+text" type="button" role="tab" aria-controls="background-images+text" aria-selected="false"><small>Porquê Nós</small></button>
                            ...
                            <div class="tab-content mt-5" id="nav-tabContent">
                                ...
                                <div class="tab-pane fade" id="image-tabs-text" role="tabpanel" aria-labelledby="image-tabs-text-tab">
                                 ...
                                 <div class="tab-pane fade show active" id="background-images+text" role="tabpanel" aria-labelledby="background-images+text-tab">
                                    <form class="row g-3 needs-validation" novalidate action="{{ route('home-page.update', 2) }}" method="post" enctype="multipart/form-data">
                                      @csrf
                                      @method('PUT')
                                      <div class="col-12 mt-5">
