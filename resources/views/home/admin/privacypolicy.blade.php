                          ...
                          <div class="card-body">
                            <nav>
                              <div class="nav nav-tabs overflow-scroll" id="nav-tab" role="tablist">
                                ...
                                <button class="nav-link" id="quote-form-tab" data-bs-toggle="tab" data-bs-target="#quote-form" type="button" role="tab" aria-controls="quote-form" aria-selected="false"><small>Formulário</small></button>
								...
								<button class="nav-link active" id="policy-privacy-tab" data-bs-toggle="tab" data-bs-target="#policy-privacy" type="button" role="tab" aria-controls="policy-privacy" aria-selected="false"><small>Política de Privacidade</small></button>
                            ...
                            <div class="tab-content mt-5" id="nav-tabContent">
                                ...
                                <div class="tab-pane fade" id="nav-paragraph" role="tabpanel" aria-labelledby="nav-paragraph-tab">
                                    <form class="row g-3 needs-validation" novalidate action="{{ route('home-page.update', 2) }}" method="post">
                                      @csrf
                                      @method('PUT')
                                ...
                                <div class="tab-pane fade" id="quote-form" role="tabpanel" aria-labelledby="quote-form-tab">
                                    <form class="row g-3" action="{{ route('home-page.update', 2) }}" method="post">
                                      @csrf
                                      @method('PUT')
                                      <div class="col-12 mt-5">
                                ...
                                <div class="tab-pane fade" id="carrousel" role="tabpanel" aria-labelledby="carrousel-tab">
                                    ...
                                    <form class="row g-3 needs-validation" novalidate action="{{ route('home-page.update', 2) }}" method="post" enctype="multipart/form-data">
                                      @csrf
                                      @method('PUT')
								...
								<!-- POLICY PRIVACY -->
                                <div class="tab-pane fade show active" id="policy-privacy" role="tabpanel" aria-labelledby="policy-privacy-tab">
                                    ...
                                    <form class="row g-3 needs-validation" novalidate action="{{ route('home-page.update', 2) }}" method="post" enctype="multipart/form-data">
									  ...
									  <div class="col-12 mt-5">
										...
										<input type="text" class="form-control" id="validationCustom01" value="{{ $policy_privacy[0]['meta-title'] }}" name="meta-title" required>
									</div>
									<div class="col-12 mt-5">
										<label for="validationCustom01" class="form-label" style="float:left;">Meta Description (PT)</label>
										<input type="text" class="form-control" id="validationCustom01" value="{{ $policy_privacy[0]['meta-desctiption'] }}" name="meta-desctiption"  required>
									</div>
									<div class="col-12 mt-5">
										<label for="validationCustom01" class="form-label" style="float:left;">Meta Keywords (PT)</label>
										<input type="text" class="form-control" id="validationCustom01" value="{{ $policy_privacy[0]['meta-keywords'] }}" name="meta-keywords" required>
									</div>
                                      <div class="col-12">
