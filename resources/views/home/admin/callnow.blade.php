                          ...
                          <div class="card-body">
                            <nav>
                              <div class="nav nav-tabs overflow-scroll" id="nav-tab" role="tablist">
                                {{-- <button class="nav-link" id="nav-paragraph-tab" data-bs-toggle="tab" data-bs-target="#nav-paragraph" type="button" role="tab" aria-controls="nav-paragraph" aria-selected="false"><small>Parágrafo de navegação</small></button>
                                ...
                                <button class="nav-link active" id="call-now-image-box-tab" data-bs-toggle="tab" data-bs-target="#call-now-image-box" type="button" role="tab" aria-controls="call-now-image-box" aria-selected="false"><small>Contacto</small></button>
                            ...
                            <div class="tab-content mt-5" id="nav-tabContent">
                                ...
                                <div class="tab-pane fade" id="four-images+collapse-box" role="tabpanel" aria-labelledby="four-images+collapse-box-tab">
                                 ...
                                 <!-- CALL US -->
                                <div class="tab-pane fade show active" id="call-now-image-box" role="tabpanel" aria-labelledby="call-now-image-box-tab">
