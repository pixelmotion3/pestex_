                          ...
                          <div class="card-body">
                            <nav>
                              <div class="nav nav-tabs overflow-scroll" id="nav-tab" role="tablist">
                                ...
                                <button class="nav-link active" id="background-image+form-tab" data-bs-toggle="tab" data-bs-target="#background-image+form" type="button" role="tab" aria-controls="background-image+form" aria-selected="false"><small>Contact Us</small></button>
                                <!--
                            ...
                            <div class="tab-content mt-5" id="nav-tabContent">
                                ...
                                <div class="tab-pane fade show active" id="background-image+form" role="tabpanel" aria-labelledby="background-image+form-tab">
                                    <form class="row g-3 needs-validation" novalidate action="{{ route('home-page.update', 2) }}" method="post" enctype="multipart/form-data">
                                      @csrf
                                      @method('PUT')
                                      <div class="col-12 mt-5">
