                          ...
                          <div class="card-body">
                            <nav>
                              <div class="nav nav-tabs overflow-scroll" id="nav-tab" role="tablist">
                                ...
                                <button class="nav-link active" id="three-icon-boxes-tab" data-bs-toggle="tab" data-bs-target="#three-icon-boxes" type="button" role="tab" aria-controls="three-icon-boxes" aria-selected="false"><small>Intro</small></button>
                            ...
                            <div class="tab-content mt-5" id="nav-tabContent">
                                ...
                                <!-- Three Icon Boxes-->
                                <div class="tab-pane fade show active" id="three-icon-boxes" role="tabpanel" aria-labelledby="three-icon-boxes-tab">
                                    <form class="row g-3 needs-validation" novalidate action="{{ route('home-page.update', 2) }}" method="post">
                                      @csrf
                                      @method('PUT')
                                      <div class="col-12 mt-5">
