...
<body class="custom-cursor" style="overflow-x: hidden;">
    ...
    <div class="preloader">
        <div class="preloader__image" style="background-image: url(/assets/images/logo-dark.png);" loading="lazy"></div>
    </div>
    <!-- Modal -->
                                    ...
                                    <form class="form-contacts" method="post"
                                        ...
                                        <div class="row text-center">
                                            ...
                                            <input class="input-field rounded" type="hidden" value="QuoteForm"
                                                placeholder="type_form" name="type_form">
                                            <input class="input-field rounded" type="hidden" value=""
                                                placeholder="type_form" name="user_email_check"
                                                id="user_email_check">
    ...
    <div class="page-wrapper">
        ...
        <section class="main-slider-one" id="home">
                                ...
                                <div class="col-md-12">
                                    <div class="main-slider-one__content">
                                        ...
                                        <h2 class="main-slider-one__title">{{ $main_screen[0]['carrousel-h2'] }}
                                            <br />
                                            {{ $main_screen[0]['carrousel-h2-a'] }}</h2><!-- slider-title -->
         ...
         -->
            ...
            <div class="main-slider-one__project wow slideInRight animated text-center shadow-lg bg-light"
				...
				style="visibility: visible; animation-name: slideInRight;" --}} style="min-width: 400px;z-index:1;border-radius:30px;">
                    ...
                    <div class="col-lg-4 col-md-6 wow slideInUp animated"
                        ...
                        <div class="service-one__item text-center">
                            <div class="service-one__item__image"
                                onclick="window.open('/servicos/{{ $best_service[0]['best-service-id-1'] }}')"
                                id="">
                                ...
                                <div class="service-one__item__icon">
                                    ...
                                    @if (
                                        $best_service[0]['best-service-a-1'] == 'Gorgulho das Farinhas' ||
                                            $best_service[0]['best-service-a-1'] == 'gorgulho das farinhas')
                                        <img src="../assets/svg/icons/new-white/gorgulho-farinhas.svg"
                                            width="60" alt="tolak" loading="lazy">
                                    @endif
                                    ...
                                    @if (
                                        $best_service[0]['best-service-a-1'] == 'Peixinho-de-Prata' ||
                                            $best_service[0]['best-service-a-1'] == 'peixinho-de-prata')
                                        <img src="../assets/svg/icons/new-white/peixinho-prata.svg" width="60"
                                            alt="tolak" loading="lazy">
                                    @endif

                                    @if ($best_service[0]['best-service-a-1'] == 'Térmitas' || $best_service[0]['best-service-a-1'] == 'térmitas')
                                        <img src="../assets/svg/icons/new-white/termita.svg" width="60"
                                            alt="tolak" loading="lazy">
                                    @endif
                                </div><!-- /.service-icon -->
                                                    ...
                                                    <div class="accrodion-title" id="accordion-{{ $i + 1 }}">
                                                        <h4>
                                                            <i class="fa fa-check-circle"
                                                                id="accordion-icon-{{ $i + 1 }}"></i>
                                                            {{ $faq['question'] }}
                                                            <span
                                                                class="accrodion-title__icon"></span><!-- /.accrodion-title__icon -->
                                                        </h4>
                                                    </div><!-- /.accordian-title -->
                                                    <div class="accrodion-content">
                                                        <div class="inner">
        ...
        <section class="cta-two" style="margin-top: 200px;">
            <div class="cta-two__shape"
                style="background-image: url({{ $call_now[0]['call-now-bg-image-1-path'] }});">
            </div>
            <div class="container">
            ...
            <div class="container" style="margin-top:100px;">
                <div class="cta-four__bg"
                    ...
                    <div class="cta-four__shape"
                        style="background-image: url(assets/images/shapes/cta-4-border.png);">
                    </div>
                    <div class="row">
                            ...
                            <div class="sec-title-four text-center">
                                ...
                                <h6 class="sec-title-four__tagline"><span
                                        class="sec-title-four__tagline__left-border"></span><b><i>FALE
                                            CONNOSCO</i></b><span
                                        class="sec-title-four__tagline__right-border"></span>
                                </h6>
            ...
            <div class="main-footer__bottom">
                <div class="container">
                    <div class="footer-developer">
                        ...
                        <div class="">
                            <p class="main-footer__copyright">
                                <a href="https://pixelinmotion.pt" style="color:#ff6600;"
                                    target="_blank">Desenvolvido
