                        ...
                        <div class="col-lg-5">
                            <div class="why-choose-two__content">
                                <div class="sec-title-two text-left">
                                    <h6 class="sec-title-two__tagline"><span class="sec-title-two__tagline__left icofont-rounded-double-left"></span>{{ $choose_us[0]['choose-us-p-1'] }}<span class="sec-title-two__tagline__right icofont-rounded-double-right"></span></h6><!-- /.sec-title-two__tagline -->
                                    <h3 class="sec-title-two__title">{{ $choose_us[0]['choose-us-h3'] }}</h3><!-- /.sec-title-two__title -->
                                </div><!-- /.sec-title-two -->
            ...
            <section>
                <div class="container" style="margin-top:50px;">
                    <div class="sec-title-two text-center">
                        <h6 class="sec-title-two__tagline"><span class="sec-title-two__tagline__left icofont-rounded-double-left"></span>{{ $testimonial_say[0]['testimonial-say-p-strong'] }}<span class="sec-title-two__tagline__right icofont-rounded-double-right"></span></h6><!-- /.sec-title-two__tagline -->
                        <h3 class="sec-title-two__title">{{ $testimonial_say[0]['testimonial-say-h2'] }}</h3><!-- /.sec-title-two__title -->
                    </div>
                      <div class="row text-center">
                        <div class="col-sm-12 col-md-3 testimonial-boxes text-center text-primary bg-dark w-100">
                          ...
                          <blockquote>
                              ...
                              <h3 class="h3 text-white"><strong>{{ $testimonial_say[0]['testimonial-say-h3-1'] }}</strong></h3>
                              <h5 class="h5 text-white-50"><strong>{{ $testimonial_say[0]['testimonial-say-h5-1'] }}</strong></h5>
                        ...
                        <div class="col-sm-12 col-md-3 testimonial-boxes text-center text-primary bg-dark w-100">
                          ...
                          <blockquote>
                              ...
                              <h3 class="h3 text-white"><strong>{{ $testimonial_say[0]['testimonial-say-h3-2'] }}</strong></h3>
                              <h5 class="h5 text-white-50"><strong>{{ $testimonial_say[0]['testimonial-say-h5-2'] }}</strong></h5>
                              <div class="d-flex justify-content-around m-5">
                                  <i class="fa fa-star text-primary" aria-hidden="true"></i>
                                  <i class="fa fa-star text-primary" aria-hidden="true"></i>
                                  <i class="fa fa-star text-primary" aria-hidden="true"></i>
                        ...
                        <div class="col-sm-12 col-md-3 testimonial-boxes text-center text-primary bg-dark w-100">
                          ...
                          <blockquote>
                              ...
                              <h3 class="h3 text-white"><strong>{{ $testimonial_say[0]['testimonial-say-h3-3'] }}</strong></h3>
                              <h5 class="h5 text-white-50"><strong>{{ $testimonial_say[0]['testimonial-say-h5-3'] }}</strong></h5>
                              <div class="d-flex justify-content-around m-5">
                                  <i class="fa fa-star text-primary" aria-hidden="true"></i>
                                  <i class="fa fa-star text-primary" aria-hidden="true"></i>
                                  <i class="fa fa-star text-primary" aria-hidden="true"></i>
                        ...
                        <div class="col-lg-6">
                            <div class="funfact-one__image">
                                ...
                                <div class="funfact-one__item count-box tolak-tilt" data-tilt-options='{ "glare": false, "maxGlare": 0, "maxTilt": 9, "speed": 700, "scale": 1 }'>
                                    <h3 class="funfact-one__item__count"><span class="count-text" data-stop="63" data-speed="1500"></span>{{ $collapse[0]['collapse-h3-1'] }}</h3><!-- /.funfact-one__number -->
                                    <p class="funfact-one__item__text">{{ $collapse[0]['collapse-p-1'] }}</p><!-- /.funfact-one__title -->
                                ...
                                <div class="funfact-one__item funfact-one__item--two count-box tolak-tilt" data-tilt-options='{ "glare": false, "maxGlare": 0, "maxTilt": 9, "speed": 700, "scale": 1 }'>
                                    <h3 class="funfact-one__item__count"><span class="count-text" data-stop="26" data-speed="1500"></span>{{ $collapse[0]['collapse-h3-2'] }}</h3><!-- /.funfact-one__number -->
                                    <p class="funfact-one__item__text">{{ $collapse[0]['collapse-p-2'] }}</p><!-- /.funfact-one__title -->
                                </div><!-- /.funfact-one__item -->
                                <div class="funfact-one__item funfact-one__item--three count-box tolak-tilt" data-tilt-options='{ "glare": false, "maxGlare": 0, "maxTilt": 9, "speed": 700, "scale": 1 }'>
                                    <h3 class="funfact-one__item__count"><span class="count-text" data-stop="34" data-speed="1500"></span>{{ $collapse[0]['collapse-h3-3'] }}</h3><!-- /.funfact-one__number -->
                                    <p class="funfact-one__item__text">{{ $collapse[0]['collapse-p-3'] }}</p><!-- /.funfact-one__title -->
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                        ...
                        <div class="row">
                            <div class="col-lg-6 wow fadeInUp" data-wow-delay="00ms">
                                <div class="cta-four__content">
                                    ...
                                    <div class="sec-title-two text-left">
                                        <h6 class="sec-title-two__tagline"><span class="sec-title-two__tagline__left icofont-rounded-double-left"></span>{{ $video_contact[0]['watch-video-p-strong-1'] }}<span class="sec-title-two__tagline__right icofont-rounded-double-right"></span></h6><!-- /.sec-title-two__tagline -->
                                        <h3 class="sec-title-two__title">{{ $video_contact[0]['watch-video-h2'] }}</h3><!-- /.sec-title-two__title -->
                                    </div><!-- /.sec-title-two -->
