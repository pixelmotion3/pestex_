                        ...
                        <div class="card-body">
                          <nav>
                            <div class="nav nav-tabs overflow-scroll" id="nav-tab" role="tablist">
                              <button class="nav-link active" id="main-screen-tab" data-bs-toggle="tab" data-bs-target="#main-screen" type="button" role="tab" aria-controls="main-screen" aria-selected="false"><small>All methods</small></button>
                              <button class="nav-link" id="services-tab" data-bs-toggle="tab" data-bs-target="#services" type="button" role="tab" aria-controls="services" aria-selected="false"><small>All Services</small></button>
                              <button class="nav-link" id="create-services-tab" data-bs-toggle="tab" data-bs-target="#create-services" type="button" role="tab" aria-controls="create-services" aria-selected="false"><small>Create Service</small></button>
                            </div>
                          </nav>
                          <div class="tab-content mt-5" id="nav-tabContent">
                            <!-- main screen -->
                            <div class="tab-pane fade show active" id="main-screen" role="tabpanel" aria-labelledby="main-screen-tab">gergergr</div>
                             <!-- Services -->
                            <div class="tab-pane fade" id="services" role="tabpanel" aria-labelledby="services-tab">grgregeg</div>
                            <!-- create-services -->
                            <div class="tab-pane fade show" id="create-services" role="tabpanel" aria-labelledby="create-services-tab">hwtght</div>
                            <!-- Testimonial -->
                            <div class="tab-pane fade show" id="testimonial" role="tabpanel" aria-labelledby="testimonial-tab">herhetgerg</div>
                            <!-- Contact Info -->
