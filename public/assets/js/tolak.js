(function ($) {
  ...
  /*-- Update --*/
  /*------ Language Toggler -----*/
  $('.topbar-five__language > a').on('click', function (e) {
    e.preventDefault();
    $('.topbar-five__language__dropdown').slideToggle();
  });

  $(document).ready(function() {
    // Primary tab click event (Commercial and Residence tabs)
    /*
    $('.nav-tabs li a').click(function(e) {
      e.preventDefault();
      
      // Remove 'active' class from all primary tabs and add to the clicked tab
      ...
      // Only switch primary tab panels without affecting inner tabs
